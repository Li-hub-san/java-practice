...
public class Exercises {
    ...
    public void exercise3() {
        ...
        List<Integer> ages = requestAges(numberOfClassMates);
    ...
    private List<Integer> requestAges(int numberOfClassMates) {
    ...
    private double calculateAverageAge(List<Integer> ages) {
        ...
        for (int currentAge : ages) {
            totalAgesSum += currentAge;
        }

        return totalAgesSum / ages.size();
    }
